...
def start(update: Update, context: CallbackContext) -> None:
    ...
    if user is None:
        ...
        # User exists in database, no need to ask for contact information again
...
def select_lang(update: Update, context: CallbackContext) -> None:
    ...
    update.message.reply_text('Choose the language you want to translate to', reply_markup=reply_markup)
...
def reply(update, context):
    ...
    user = cur.fetchone()
    if user is None:
        # the user hasn't shared their contact yet
        update.message.reply_text("Please share your contact information first.")
    else:
